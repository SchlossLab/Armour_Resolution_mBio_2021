...
mv $MOTHUR/data.trim.contigs.good.unique.good.filter.unique.precluster.pick.pick.fasta $MOTHUR/data.fasta
mv $MOTHUR/data.trim.contigs.good.unique.good.filter.unique.precluster.denovo.uchime.pick.pick.count_table $MOTHUR/data.count_table
mv $MOTHUR/data.trim.contigs.good.unique.good.filter.unique.precluster.pick.pds.wang.pick.taxonomy $MOTHUR/data.taxonomy
